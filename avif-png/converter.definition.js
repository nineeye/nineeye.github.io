/** AVIF → PNG converter definition. */
export const AVIF_PNG_DEFINITION = Object.freeze({
  "id": "avif-png",
  "stage": 100,
  "version": "1.22.0",
  "runtimeVersion": "v1.22.0-source-aware",
  "title": "AVIF → PNG",
  "description": "AVIF 이미지를 고품질 PNG 형식으로 변환합니다.",
  "source": {
    "format": "AVIF",
    "extensions": [
      "avif"
  ...
  "storageKeys": {
    "settings": "converterMall.avifpng.settings.v1",
    "history": "converterMall.avifpng.history.v1",
    "session": "converterMall.avifpng.session.v1",
    "theme": "converterMall.theme",
    "downloadReceipt": "converterMall.avifpng.lastDownload.v1"
  },
  "defaults": {
    "quality": 0.9,
    "background": "#ffffff",
    "resizeMode": "original",
    "resizeValue": 1920,
    "zipName": "converter-mall-avif-to-png"
  }
});

export default AVIF_PNG_DEFINITION;
