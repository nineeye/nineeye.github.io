/** AVIF → WEBP converter definition. */
export const AVIF_WEBP_DEFINITION = Object.freeze({
  "id": "avif-webp",
  "stage": 100,
  "version": "1.22.0",
  "runtimeVersion": "v1.22.0-source-aware",
  "title": "AVIF → WEBP",
  "description": "AVIF 이미지를 고품질 WEBP 형식으로 변환합니다.",
  "source": {
    "format": "AVIF",
    "extensions": [
      "avif"
  ...
  "storageKeys": {
    "settings": "converterMall.avifwebp.settings.v1",
    "history": "converterMall.avifwebp.history.v1",
    "session": "converterMall.avifwebp.session.v1",
    "theme": "converterMall.theme",
    "downloadReceipt": "converterMall.avifwebp.lastDownload.v1"
  },
  "defaults": {
    "quality": 0.9,
    "background": "#ffffff",
    "resizeMode": "original",
    "resizeValue": 1920,
    "zipName": "converter-mall-avif-to-webp"
  }
});

export default AVIF_WEBP_DEFINITION;
