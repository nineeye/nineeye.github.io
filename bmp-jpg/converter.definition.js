/** BMP → JPG converter definition. */
export const BMP_JPG_DEFINITION = Object.freeze({
  "id": "bmp-jpg",
  "stage": 100,
  "version": "1.22.0",
  "runtimeVersion": "v1.22.0-source-aware",
  "title": "BMP → JPG",
  "description": "BMP 이미지를 고품질 JPG 형식으로 변환합니다.",
  "source": {
    "format": "BMP",
    "extensions": [
      "bmp"
  ...
  "storageKeys": {
    "settings": "converterMall.bmpjpg.settings.v1",
    "history": "converterMall.bmpjpg.history.v1",
    "session": "converterMall.bmpjpg.session.v1",
    "theme": "converterMall.theme",
    "downloadReceipt": "converterMall.bmpjpg.lastDownload.v1"
  },
  "defaults": {
    "quality": 0.9,
    "background": "#ffffff",
    "resizeMode": "original",
    "resizeValue": 1920,
    "zipName": "converter-mall-bmp-to-jpg"
  }
});

export default BMP_JPG_DEFINITION;
